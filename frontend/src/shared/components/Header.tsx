  ...
  return (
    <>
      <header className="h-14 bg-[#0d131f] border-b border-slate-800/80 px-3 sm:px-4 flex items-center justify-between shrink-0 select-none backdrop-blur-md gap-2">
        ...
        {/* Right Controls: Search, Settings & Profile */}
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg bg-slate-900/80 hover:bg-slate-800 border border-slate-800 hover:border-slate-700 text-slate-400 hover:text-slate-200 text-xs transition group"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-slate-900/80 hover:bg-slate-800 border border-slate-800 hover:border-teal-500/50 text-slate-300 hover:text-teal-400 transition"
